		...
		<div class="posts col-md-9 col-12">
			...
			<div class="row add-post">
				...
				<form action="create.php" method="post">
					...
					<input name="admin" class="form-check-input" style="margin: 15px 0;" value="1" type="checkbox" id="flexCheckChecked">
					<label class="form-check-label" style="margin: 15px 0;" for="flexCheckChecked">
						Admin?
					</label>
					<div class="col">
