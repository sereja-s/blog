		...
		<div class="posts col-md-9 col-12">
			...
			<div class="row add-post">
				...
				<form action="create.php" method="post">
					...
					<div class="col">
						<label for="content" class="form-label" style="margin: 10px;">Описание категории</label>
						<textarea name="description" class="form-control" id="content" rows="3"><?= $description; ?></textarea>
					</div>
					<div class="col">
						<button name="topic-create" class="btn btn-primary" style="margin: 20px;" type="submit">Создать категорию</button>
					</div>
				</form>
			</div>
