			...
			<div class="row add-post">
				...
				<form action="edit.php" method="post">
					...
					<div class="form-check">
						...
						<input name="publish" class="form-check-input" style="margin: 20px 0;" type="checkbox" id="flexCheckChecked" <?= $checked; ?>>
						<label class="form-check-label" style="margin: 20px 0;" for="flexCheckChecked">
							Publish
						</label>
					</div>
					<div class="col col-6">
