			...
			<div class="row add-post">
				...
				<form action="create.php" method="post" enctype="multipart/form-data">
					...
					<div class="col">
						...
						<textarea name="content" id="editor" class="form-control" rows="7"><?= $content; ?></textarea>
					</div>
					...
					<div class="form-check">
						<input name="publish" class="form-check-input" style="margin: 20px 0;" type="checkbox" value="1" id="flexCheckChecked" checked>
						<label class="form-check-label" style="margin: 20px 5px;" for="flexCheckChecked">
							опубликовать
						</label>
					</div>
					<div class="col">
