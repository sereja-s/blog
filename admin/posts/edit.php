				...
				<form action="edit.php" method="post" enctype="multipart/form-data">
					...
					<div class="form-check">
						<?php if (empty($publish) && $publish == 0) : ?>
							<input name="publish" class="form-check-input" style="margin: 10px 0;" type="checkbox" id="flexCheckChecked">
							<label class="form-check-label" style="margin: 10px;" for="flexCheckChecked">
								Publish
							</label>
						<?php else : ?>
							<input name="publish" class="form-check-input" style="margin: 10px 0;" type="checkbox" id="flexCheckChecked" checked>
							<label class="form-check-label" style="margin: 10px;" for="flexCheckChecked">
								Publish
							</label>
						<?php endif; ?>
